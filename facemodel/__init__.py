...
from facemodel.config import Config
...
def create_app(config):
    ...
    # imports blueprints
    from facemodel.errors.handlers import error
    from facemodel.takeImage.routes import raw_image_bp
    from facemodel.IdentifyImage.routes import identify_image_bp
    from .util_routes import util_bp


    # register blueprint
    app.register_blueprint(raw_image_bp)
    app.register_blueprint(error)
    app.register_blueprint(util_bp)
    app.register_blueprint(identify_image_bp)
